/*
  # Fix double decrement of available quantity

  1. Changes
    - Update create_emprunt function to not modify quantity
    - Let the trigger handle all quantity updates
*/
...
BEGIN
  ...
  -- Créer l'emprunt (le trigger update_item_quantity s'occupera de la mise à jour de la quantité)
